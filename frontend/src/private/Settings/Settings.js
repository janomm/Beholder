        ...
        <React.Fragment>
            ...
            <main className="content">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" id="phone" type="tel" placeholder="+5551123456789" defaultValue={settings.phone} onChange={onInputChange} />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <input className="form-control" id="newPassword" type="password" placeholder="Enter your new password" onChange={onInputChange} />
                                    </div>
                                </div>
                                <div className="col-md-6 mb-3">
                                    <div>
                ...
                <div className='row'>
                    <div className='col-12'>
                        <div className="card card-body border-0 shadow mb-4">
                            <h2 className="h5 mb-4">Alert Settings</h2>
                            <div className="row">
                                <div className="col-sm-12 mb-3">
                                    <div className="form-group">
                                        <label htmlFor="sendGridKey">SendGrip Api Key</label>
                                        <input className="form-control" id="sendGridKey" type="text" placeholder="Enter the SendGrip Api Key" defaultValue={settings.sendGridKey} onChange={onInputChange} />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                ...
                <div className='row'>
                    <div className='col-12'>
                        <div className="card card-body border-0 shadow mb-4">
                            <h2 className="h5 mb-4">Binance Settings</h2>
                            <div className="row">
                                <div className="col-sm-12 mb-3">
                                    <div className="form-group">
                                        <label htmlFor="apiUrl">API URL</label>
                                        <input className="form-control" id="apiUrl" type="text" placeholder="Your API URL" defaultValue={settings.apiUrl} onChange={onInputChange} />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                <div className="col-sm-12 mb-3">
                                    <div className="form-group">
                                        <label htmlFor="accessKye">Access Key</label>
                                        <input className="form-control" id="accessKey" type="text" placeholder="Enter the API Secret Key" defaultValue={settings.accessKey} onChange={onInputChange} />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-sm-12 mb-3">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" id="secretKey" type="password" placeholder="Your secret key" onChange={onInputChange} />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
